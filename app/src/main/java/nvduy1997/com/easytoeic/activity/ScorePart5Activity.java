...
public class ScorePart5Activity extends AppCompatActivity {
    ...
    ArrayList<QuestionPart5> arr_QuesBegin = new ArrayList<>();
    private String nameTest, date;
    int numNotAns = 0;
    int numTrue = 0;
    int numFalse = 0;
    int totalScore;
    private DatabaseManager databaseManager = new DatabaseManager(ScorePart5Activity.this);
    ...
    public void initlizeComponents() {
        ...
        btnSaveScore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ScorePart5Activity.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Score score = new Score(nameTest, "Part5", date, totalScore, numTrue, numFalse, numNotAns);
                        databaseManager.addScore(score);

                        Toast.makeText(ScorePart5Activity.this, "Save Score Successfull", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void showMenu() {
        PopupMenu popupMenu = new PopupMenu(ScorePart5Activity.this, imgShare);
    ...
    public void shareFaceBook() {
        shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
                    ...
                    public void onSuccess(Sharer.Result result) {
                        Toast.makeText(ScorePart5Activity.this, "Share Successfull", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancel() {
                        Toast.makeText(ScorePart5Activity.this, "Share Cancel", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onError(FacebookException error) {
                        Toast.makeText(ScorePart5Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        ShareLinkContent shareLinkContent = new ShareLinkContent.Builder()
                .setQuote("This is App Toeic TBD - " + nameTest + " - Part5 - Score : " + totalScore)
    ...
    public void shareGoogle() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Part5 - " + nameTest + " - " + date + " - Tota5 Score : " + totalScore);
